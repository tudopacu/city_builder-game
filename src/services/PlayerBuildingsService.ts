...
import {BuildingsMenu} from "../ui/BuildingsMenu";

export class PlayerBuildingsService {
    private isLoadingBuildingList = false;
    private buildingsMenu: BuildingsMenu | null = null;
    ...
    private async showBuildingList(): Promise<void> {
        ...
        this.buildingsMenu = new BuildingsMenu(
            this.scene,
            this.hudLayer,
            buildings,
            (building) => this.startBuildingPlacement(building),
        );
        this.buildingsMenu.show();
    }
    ...
    private closeBuildingList(): void {
        if (this.buildingsMenu) {
            this.buildingsMenu.close();
            this.buildingsMenu = null;
        }
    }
